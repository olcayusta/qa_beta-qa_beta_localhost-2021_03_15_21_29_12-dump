...
3	7	1	Merhaba dunya.	1	2020-09-10 22:24:06.637231+03	f
\.
...
47	<p>The slash <code>/</code> is evaluated as a path segment as <a href="https://tools.ietf.org/html/rfc3986#section-1.2.3">written in the standard</a></p>\n<p>To archive your goal you need to:</p>\n<ol>\n<li>define the <code>path</code> as a query parameter</li>\n<li>or define the path parameter but encode it in a format that doesn&#39;t use <code>/</code>, like the base64</li>\n</ol>\n<p>Example 1:</p>\n<pre><code class="language-js">const fastify = require(&#39;fastify&#39;)()\n\nfastify.get(&#39;/dir&#39;, {\n  schema: {\n    querystring: {\n      type: &#39;object&#39;,\n      required: [&#39;path&#39;],\n      properties: {\n        path: { type: &#39;string&#39; }\n      }\n    }\n  }\n},\n\nasync function (request, reply) {\n  return request.query\n})\n\nfastify.listen(8080)\n\n// call it with: http://localhost:8080/dir?path=/\n</code></pre>\n	2021-02-18 19:49:27.50194+03	1	60	\N
\.
...
9	How to pass file or directory path as a REST API parameter to Fistify endpoint	<p>Actually the question is in the header. A REST endpoint definition is below:</p>\n<pre><code>fastify.get(&#39;/dir/:path&#39;, async (request, reply) =&gt; {\n    let res = await remote.getDir(request.params.path);\n    return { res:  res}\n})\n</code></pre>\n<p>And a call is like </p>\n<blockquote>\n<p><a href="http://127.0.0.1:3000/dir//">http://127.0.0.1:3000/dir//</a></p>\n</blockquote>\n<p>The problem is that Fastify treats the path parameter as continuation of the URL, and says: <code>&quot;Route GET:/dir// not found&quot;</code></p>\n	2021-02-09 01:29:26.910506+03	60	3	{9,8}
\.
...
54	60	9	2021-02-09 01:29:26.910506+03
55	60	8	2021-02-09 01:29:26.910506+03
56	61	9	2021-02-18 19:54:50.999726+03
57	62	9	2021-02-18 19:55:29.034885+03
\.
...
7	jessie1@mail.com	123456	Jessica Parker	https://i.pinimg.com/originals/23/44/f9/2344f9e0a9dabf6bb153071b5d5e0984.jpg	2020-08-21 04:06:31.379266+03	\N
8	sloh@mail.com	123456	SLOH Pink Cool	https://i.pinimg.com/236x/9b/91/58/9b9158fd5f3456fb4daa993a5ea43e3f.jpg	2020-08-28 11:30:56.948947+03	\N
20	irmak@mail.com	123456	Irmak Sevinç	https://i.pinimg.com/236x/59/88/ca/5988ca12fbcef9c60ab0b73ec027a6ff.jpg	2020-10-19 16:44:01.791771+03	\N
15	famosa@mail.com	123456	Funda İrem	https://i.pinimg.com/236x/a6/f6/84/a6f684e87d80763993aac4acc3b9c3d4.jpg	2020-09-19 07:41:45.868564+03	\N
21	aysu@mail.com	123456	Aysu Güçin	https://i.pinimg.com/236x/5d/f8/45/5df8452f173490b930221a337b170bb9.jpg	2020-10-19 18:45:55.245831+03	\N
1	yonca@mail.com	123456	Yonca Nisanur	https://i.pinimg.com/236x/ec/25/ee/ec25ee47ca98b373d5a093847cf76498.jpg	2020-08-15 04:11:24.609176+03	\N
3	olcay@mail.com	123456	Olcay Usta	https://i.pinimg.com/236x/8e/07/ec/8e07ec5b62eec990a5ad8d862d69c2bb.jpg	2020-08-15 19:26:45.713453+03	\N
9	jojo@mail.com	123456	JoJo	https://i.pinimg.com/236x/d7/c0/57/d7c057cdc61044d71447e9c084507fc8.jpg	2020-08-28 13:41:00.50064+03	olcayusta
17	zubeyde@mail.com	123456	Zübeyde Banu	https://i.pinimg.com/236x/bd/fe/00/bdfe006232c43aa4b0dd8222139dd33f.jpg	2020-09-26 00:20:04.460815+03	\N
\.
...
11	60	3	2021-02-19 05:49:56.897875+03
\.
...
5	21	3	2021-03-08 21:40:57.948759+03
\.
...
SELECT pg_catalog.setval('public.question_id_seq', 97, true);
...
SELECT pg_catalog.setval('public.question_revision_id_seq', 46, true);
...
SELECT pg_catalog.setval('public.question_tag_id_seq', 57, true);
...
SELECT pg_catalog.setval('public.user_favorite_questions_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.user_favorite_tags_id_seq', 5, true);
